...
<div class="pageContent">
	<form method="post" action="${ctx}/dic/category/add?navTabId=${param.navTabId}&dialogId=${param.dialogId}" class="pageForm required-validate"
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>分类名称：</label>
				<input name="name" class="required" type="text" size="35"/>
			</p>
			<p>
				<label>启用状态：</label>
