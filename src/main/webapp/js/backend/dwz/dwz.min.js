...
var aClass=cked?"rawtypes":"checked";
var rClass=cked?"checked":"rawtypes";
...
ckbox.removeClass("rawtypes").addClass("checked");
$(node)._checkParent();}},
...
var aClass=(ckboxed==ckbox?"checked":(ckboxed!=0?"indeterminate":"rawtypes"));
var rClass=(ckboxed==ckbox?"indeterminate":(ckboxed!=0?"checked":"indeterminate"));
$(">div>.ckbox",parent).removeClass("rawtypes").removeClass("checked").removeClass(rClass).addClass(aClass);
